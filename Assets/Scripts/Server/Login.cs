...
public class Login : MonoBehaviour
{
    ...
    [SerializeField] private State playerState;       // 초기 플레이어 상태

    [Header("Next Scnene Name")]
    ...
    private readonly string loginUrl = "6a72ac4cda5bc5ca3" +
        "e20a917ac4fa746d99765c4d6cd4ffbdc759da1a850e8422" +
        "3fd2a491b419a7c5d9fe85d67b4d37ae5099a1de9c4c9c37" +
        "f10e28c7b47ada9f4d5acf15bde320a042017aba65cf90c" +
        "6e64c812b32e4748bbc62e1ddd12460e";
    ...
    private MySqlCommand PlayerInfoCreate()
    {
        ...
        // INSERT 쿼리 생성
        string infoQuery = "INSERT INTO PlayerInfo (ID, Name, Level, MaxHP, CurrentHP, Damage, Defense, Critical, MoveSpeed, JumpPower, MaxJump, DashBarCount, Food, Money) " +
                       "VALUES(@ID, @Name, @Level, @MaxHP, @CurrentHP, @Damage, @Defense, @Critical, @MoveSpeed, @JumpPower, @MaxJump, @DashBarCount, @Food, @Money);";
